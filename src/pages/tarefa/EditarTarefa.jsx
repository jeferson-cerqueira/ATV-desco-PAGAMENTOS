  ...
  return(
    <Grid container spacing={2}>
      <Card sx={style}>
        <CardHeader
          title="PAGAMENTOS"
          subheader="Organização de pagamentos"
        /> 
        <CardContent sx={{
          width: '95%',
          maxWidth: '100%',
          ...
          <Grid item xs={12}>
            <FormControl fullWidth>
              ...
              <FormHelperText id="tarefa_titulo_helper_text">Título do Pagamento.</FormHelperText>
            </FormControl>
          </Grid>
          <Grid item xs={12}>  
            <FormControl fullWidth>
              ...
              <FormHelperText id="tarefa_descricao_helper_text">Descrição do Pagamento.</FormHelperText>
            </FormControl>
          </Grid>
          <Grid container spacing={2} mt={1}>
            <Grid item xs={3}>  
              <FormControl>
                ...
                />
                <FormHelperText id="tarefa_inicio_helper_text">Início do Pagamento.</FormHelperText>
              </FormControl>
            </Grid>  
            <Grid item xs={3}>  
              <FormControl>
                ...
                />
                <FormHelperText id="tarefa_fim_helper_text">Fim do Pagamento.</FormHelperText>
              </FormControl>
            </Grid>
            <Grid item xs={3}>  
              <FormControl fullWidth>
                <InputLabel htmlFor="tarefa_recurso">Pagamento</InputLabel>
                <Select
                  id="tarefa_recurso"
                  value={recursoTarefa}
                  label="Recurso"
            ...
            <Grid item xs={3}>  
              <FormControl fullWidth>
                ...
                >
                  <MenuItem value={'Aguardando'}>PAGO</MenuItem>
                  <MenuItem value={'Concluída'}>PAGAR</MenuItem>
                </Select>
              </FormControl>
            </Grid>
