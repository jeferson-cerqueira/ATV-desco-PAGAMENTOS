...
const initialRows = [
  createData(1, 'compras', 'ir ao mecado fazer compras', '2024-06-01', '2024-06-01', 'PAGO', 'PIX'),
  createData(2, 'abastecer', 'abastecer o carro', '2024-06-03', '2024-06-03', 'PAGAR', 'Credito'),
  createData(3, 'mecanico', 'levar o carro ao mecanico', '2024-06-04', '2024-06-04', 'PAGAR', 'Debito'),
createData(3, 'roupas', 'comprar roupas para festas', '2024-06-04', '2024-06-04', 'PAGAR', 'Debito'),
]
...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        <CardHeader
          title="Pagamento"
          subheader="Listagem de Pagamento"
        /> 
        <CardContent>
        ...
        <CardActions>
            <Button size="small" variant="contained" onClick={handleOpen}>Criar Pagamento</Button>
